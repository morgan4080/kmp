...
interface RootComponent {
    ...
    sealed class Child {
        ...
        class ProcessingLoanDisbursementChild(val component: ProcessLoanDisbursementComponent) :
            Child()
        ...
        class LongTermLoanConfirmationChild(val component: LongTermLoanConfirmationComponent) :
            Child()

        class LongTermLoanSigningStatusChild(val component: LongtermLoanSigningStatusComponent) :
            Child()
