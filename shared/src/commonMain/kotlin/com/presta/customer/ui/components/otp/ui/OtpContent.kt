...
fun OtpContent(
    ...
    LaunchedEffect(otpInput, state.otpRequestData) {
    ...
    LaunchedEffect(state.otpVerificationData, otpInput) {
        if (
            state.phone_number !== null &&
    ...
    Scaffold (modifier = Modifier
        ...
        Column(
            ...
            Box (
                modifier = Modifier.padding(start = 16.dp, end = 16.dp, bottom = 30.dp).fillMaxWidth(),
            ...
            Box (
                modifier = Modifier.padding(start = 16.dp, end = 16.dp, top = 30.dp, bottom = 30.dp).fillMaxWidth(),
                contentAlignment = Alignment.Center
            ) {
                Row(
                    modifier = Modifier
