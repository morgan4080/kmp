                    ...
                    item {
                        when(inputMethod.inputTypes) {
                            InputTypes.ENUM -> {
                                ...
                                Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp).selectableGroup()) {
                                            ...
                                            Modifier
                                                ...
                                                .selectable(
                                                    ...
                                                    onClick = {
                                                        ...
                                                        onEvent(RegistrationStore.Intent.UpdateInputValue(inputMethod.fieldType, TextFieldValue(text)))
                                                    },
