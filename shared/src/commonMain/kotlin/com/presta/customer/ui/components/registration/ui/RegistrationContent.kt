    ...
    Scaffold (
        ...
        Column(
            ...
            LazyColumn {
                ...
                state.inputs.forEachIndexed { index, inputMethod ->
                    item {
                        Column(
                            modifier = Modifier
                                .fillMaxWidth()
                            ...
                            BasicTextField (
                                ...
                                onValueChange = {
                                    onEvent(RegistrationStore.Intent.UpdateInputValue(index, it.text))
                                },
                                singleLine = true,
                                textStyle = TextStyle(
                                    ...
                                    Row (
                                        ...
                                        AnimatedVisibility(
                                            ...
                                            IconButton(
                                                ...
                                                onClick = { onEvent(RegistrationStore.Intent.UpdateInputValue(index, "")) },
                                                content = {
                                                    Icon(
